...
/* Ritmo heatmap */
.th-hm{text-align:center!important;font-size:.65rem!important;padding:9px 6px!important;min-width:52px;white-space:nowrap}
.th-total{background:rgba(255,255,255,.04)!important;border-left:1px solid var(--border2)}
.td-hm{text-align:center;padding:7px 6px!important;font-size:.82rem;vertical-align:middle;font-variant-numeric:tabular-nums}
.td-total-val{font-variant-numeric:tabular-nums;font-size:.82rem;border-left:1px solid var(--border2);color:var(--text)!important;background:rgba(255,255,255,.025)}
.td-ganadas-val{font-variant-numeric:tabular-nums;font-size:.82rem;color:#34d399!important;background:rgba(16,185,129,.05)}
.wr-pct{font-size:.68rem;color:var(--muted);font-weight:400}
.totals-row{border-top:2px solid var(--border2)!important}
.totals-row td{background:rgba(255,255,255,.03)!important}
</style>
</head>
<body>
...
<!-- Ritmo de Asignación -->
<section>
  <div class="sec-title"><span class="sec-dot" style="background:var(--purple);box-shadow:0 0 8px var(--purple)"></span>Ritmo de Asignación por SDR — Opps creadas por mes</div>
  <p style="font-size:.74rem;color:var(--muted);margin:-10px 0 16px;line-height:1.6">
    Oportunidades creadas con <b style="color:var(--text)">SDR_Soporte</b> asignado, desde Ago 2025. 
    Cada celda = opps abiertas ese mes.&nbsp;
    <span style="display:inline-flex;align-items:center;gap:6px;vertical-align:middle">
      <span style="background:rgba(59,130,246,.12);color:#93c5fd;padding:1px 7px;border-radius:3px;font-size:.7rem">1–2</span>
      <span style="background:rgba(59,130,246,.30);color:#60a5fa;padding:1px 7px;border-radius:3px;font-size:.7rem">3–5</span>
      <span style="background:rgba(59,130,246,.58);color:#fff;padding:1px 7px;border-radius:3px;font-size:.7rem">6+</span>
    </span>
    &nbsp;· Ganadas = IsWon · Porcentaje = Ganadas ÷ Total creadas
  </p>
  <div class="t-wrap">
    <table>
      <thead><tr>
        <th style="text-align:left;min-width:155px">SDR Soporte</th>
      ...
      <tbody>
        <tr class="">
      <td class="td-name" style="white-space:nowrap">Milton Rodríguez</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">174</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">2</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">2</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">179</td>
      <td class="td-hm td-ganadas-val">7 <span class="wr-pct">(4%)</span></td>
    </tr><tr class="tr-alt">
      <td class="td-name" style="white-space:nowrap">Jessica Cárdenas Álvarez</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">20</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">14</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">15</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">13</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">8</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">11</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">3</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">4</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">3</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">2</td>
      <td class="td-hm td-total-val">93</td>
      <td class="td-hm td-ganadas-val">10 <span class="wr-pct">(11%)</span></td>
    </tr><tr class="">
      <td class="td-name" style="white-space:nowrap">Ulises Castañeda</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">10</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">11</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">13</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">16</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">11</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">5</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">8</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">3</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">6</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td>
      <td class="td-hm td-total-val">84</td>
      <td class="td-hm td-ganadas-val">6 <span class="wr-pct">(7%)</span></td>
    </tr><tr class="tr-alt">
      <td class="td-name" style="white-space:nowrap">ROSA ISABEL HERNANDEZ GARCIA</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">15</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">5</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">15</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">13</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">10</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">8</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">4</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">71</td>
      <td class="td-hm td-ganadas-val">7 <span class="wr-pct">(10%)</span></td>
    </tr><tr class="">
      <td class="td-name" style="white-space:nowrap">Sandra Osuna</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">10</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">6</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">10</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">12</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">11</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">6</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">4</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">4</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td>
      <td class="td-hm td-total-val">65</td>
      <td class="td-hm td-ganadas-val">2 <span class="wr-pct">(3%)</span></td>
    </tr><tr class="tr-alt">
      <td class="td-name" style="white-space:nowrap">Andrea Espinoza</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">2</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">7</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">9</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">8</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">8</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">14</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">7</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">3</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">6</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">64</td>
      <td class="td-hm td-ganadas-val">2 <span class="wr-pct">(3%)</span></td>
    </tr><tr class="">
      <td class="td-name" style="white-space:nowrap">Dulce Perez</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">5</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">15</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">10</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">9</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">10</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">6</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">7</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td>
      <td class="td-hm td-total-val">64</td>
      <td class="td-hm td-ganadas-val">5 <span class="wr-pct">(8%)</span></td>
    </tr><tr class="tr-alt">
      <td class="td-name" style="white-space:nowrap">ZULMA DUEÑAS</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">3</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">2</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">16</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">16</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">10</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">4</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">6</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">3</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">3</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">63</td>
      <td class="td-hm td-ganadas-val">8 <span class="wr-pct">(13%)</span></td>
    </tr><tr class="">
      <td class="td-name" style="white-space:nowrap">Griselda Castañeda</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">9</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">7</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">7</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">16</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">8</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">8</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">4</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">2</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">62</td>
      <td class="td-hm td-ganadas-val">5 <span class="wr-pct">(8%)</span></td>
    </tr><tr class="tr-alt">
      <td class="td-name" style="white-space:nowrap">Fernanda Armenta</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">4</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">5</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">7</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">10</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">8</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">13</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">9</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">3</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">59</td>
      <td class="td-hm td-ganadas-val">6 <span class="wr-pct">(10%)</span></td>
    </tr><tr class="">
      <td class="td-name" style="white-space:nowrap">Veronica Guzman</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">5</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">3</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">6</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">15</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">9</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">6</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">2</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">2</td>
      <td class="td-hm td-total-val">49</td>
      <td class="td-hm td-ganadas-val">9 <span class="wr-pct">(18%)</span></td>
    </tr><tr class="tr-alt">
      <td class="td-name" style="white-space:nowrap">Mireya Gonzalez</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">3</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">2</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">3</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">13</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">7</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">3</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">7</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">3</td>
      <td class="td-hm td-total-val">42</td>
      <td class="td-hm td-ganadas-val">4 <span class="wr-pct">(10%)</span></td>
    </tr><tr class="">
      <td class="td-name" style="white-space:nowrap">Yennifer Acevedo</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">6</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">2</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">5</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">7</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">3</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">5</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">6</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">3</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">37</td>
      <td class="td-hm td-ganadas-val">2 <span class="wr-pct">(5%)</span></td>
    </tr><tr class="tr-alt">
      <td class="td-name" style="white-space:nowrap">Daniel Franco</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">5</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">6</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">8</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">5</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">3</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">5</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">2</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">35</td>
      <td class="td-hm td-ganadas-val">3 <span class="wr-pct">(9%)</span></td>
    </tr><tr class="">
      <td class="td-name" style="white-space:nowrap">Mayra Burgos</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">3</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">11</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">7</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">4</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">5</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">3</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td>
      <td class="td-hm td-total-val">35</td>
      <td class="td-hm td-ganadas-val">2 <span class="wr-pct">(6%)</span></td>
    </tr><tr class="tr-alt">
      <td class="td-name" style="white-space:nowrap">Lydia Gonzalez Rangel</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">2</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">3</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">5</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">5</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">4</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">2</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">3</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td>
      <td class="td-hm td-total-val">27</td>
      <td class="td-hm td-ganadas-val">0 <span class="wr-pct">(0%)</span></td>
    </tr><tr class="">
      <td class="td-name" style="white-space:nowrap">Mauricio Esquivel</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">8</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">8</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">6</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">2</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">26</td>
      <td class="td-hm td-ganadas-val">1 <span class="wr-pct">(4%)</span></td>
    </tr><tr class="tr-alt">
      <td class="td-name" style="white-space:nowrap">Blanca Adriana Pérez</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">6</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">6</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">12</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">25</td>
      <td class="td-hm td-ganadas-val">0 <span class="wr-pct">(0%)</span></td>
    </tr><tr class="">
      <td class="td-name" style="white-space:nowrap">Santiago Franco Zuno</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">2</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">10</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">5</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">5</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">22</td>
      <td class="td-hm td-ganadas-val">0 <span class="wr-pct">(0%)</span></td>
    </tr><tr class="tr-alt">
      <td class="td-name" style="white-space:nowrap">Samantha Garcia</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">8</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">5</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">3</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">3</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">2</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">22</td>
      <td class="td-hm td-ganadas-val">0 <span class="wr-pct">(0%)</span></td>
    </tr><tr class="">
      <td class="td-name" style="white-space:nowrap">Andrea lorena Florencio Maciel</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">8</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">3</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">11</td>
      <td class="td-hm td-ganadas-val">0 <span class="wr-pct">(0%)</span></td>
    </tr><tr class="tr-alt">
      <td class="td-name" style="white-space:nowrap">Luis Dominguez</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">10</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">11</td>
      <td class="td-hm td-ganadas-val">7 <span class="wr-pct">(64%)</span></td>
    </tr><tr class="">
      <td class="td-name" style="white-space:nowrap">Arely Quintana</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">4</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">2</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">2</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">2</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">10</td>
      <td class="td-hm td-ganadas-val">3 <span class="wr-pct">(30%)</span></td>
    </tr><tr class="tr-alt">
      <td class="td-name" style="white-space:nowrap">Fatima perez cambero</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">7</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">8</td>
      <td class="td-hm td-ganadas-val">0 <span class="wr-pct">(0%)</span></td>
    </tr><tr class="">
      <td class="td-name" style="white-space:nowrap">Ana Luisa Armadillo Hernández</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">3</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">2</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">7</td>
      <td class="td-hm td-ganadas-val">0 <span class="wr-pct">(0%)</span></td>
    </tr><tr class="tr-alt">
      <td class="td-name" style="white-space:nowrap">Fernando Carrillo</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:600">6</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">7</td>
      <td class="td-hm td-ganadas-val">0 <span class="wr-pct">(0%)</span></td>
    </tr><tr class="">
      <td class="td-name" style="white-space:nowrap">Luis Gómez</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">2</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">3</td>
      <td class="td-hm td-ganadas-val">1 <span class="wr-pct">(33%)</span></td>
    </tr><tr class="tr-alt">
      <td class="td-name" style="white-space:nowrap">Sergio Arenas</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.30);color:#60a5fa;font-weight:600">3</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">3</td>
      <td class="td-hm td-ganadas-val">0 <span class="wr-pct">(0%)</span></td>
    </tr><tr class="">
      <td class="td-name" style="white-space:nowrap">Daniel False</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">2</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">2</td>
      <td class="td-hm td-ganadas-val">0 <span class="wr-pct">(0%)</span></td>
    </tr><tr class="tr-alt">
      <td class="td-name" style="white-space:nowrap">Jorge Fuentes</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">2</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">2</td>
      <td class="td-hm td-ganadas-val">0 <span class="wr-pct">(0%)</span></td>
    </tr><tr class="">
      <td class="td-name" style="white-space:nowrap">Yvonne De La Vega</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">2</td>
      <td class="td-hm td-ganadas-val">0 <span class="wr-pct">(0%)</span></td>
    </tr><tr class="tr-alt">
      <td class="td-name" style="white-space:nowrap">Betzabeth Hernández</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">2</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">2</td>
      <td class="td-hm td-ganadas-val">0 <span class="wr-pct">(0%)</span></td>
    </tr><tr class="">
      <td class="td-name" style="white-space:nowrap">Victor Ortiz</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">1</td>
      <td class="td-hm td-ganadas-val">1 <span class="wr-pct">(100%)</span></td>
    </tr><tr class="tr-alt">
      <td class="td-name" style="white-space:nowrap">Amanda Torres Romo</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">1</td>
      <td class="td-hm td-ganadas-val">0 <span class="wr-pct">(0%)</span></td>
    </tr><tr class="">
      <td class="td-name" style="white-space:nowrap">Axel Rangel</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">1</td>
      <td class="td-hm td-ganadas-val">0 <span class="wr-pct">(0%)</span></td>
    </tr><tr class="tr-alt">
      <td class="td-name" style="white-space:nowrap">Fabiola De Anda</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">1</td>
      <td class="td-hm td-ganadas-val">0 <span class="wr-pct">(0%)</span></td>
    </tr><tr class="">
      <td class="td-name" style="white-space:nowrap">Tania Molina</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">1</td>
      <td class="td-hm td-ganadas-val">0 <span class="wr-pct">(0%)</span></td>
    </tr><tr class="tr-alt">
      <td class="td-name" style="white-space:nowrap">Daniela Soto</td>
      <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:rgba(59,130,246,.12);color:#93c5fd;font-weight:600">1</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25)">·</td>
      <td class="td-hm td-total-val">1</td>
      <td class="td-hm td-ganadas-val">1 <span class="wr-pct">(100%)</span></td>
    </tr>
        <tr class="totals-row">
          <td class="td-name" style="font-weight:700;color:var(--text)">Total</td>
          <td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25);font-weight:700">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25);font-weight:700">·</td><td class="td-hm" style="background:transparent;color:rgba(122,149,180,.25);font-weight:700">·</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:700">310</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:700">112</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:700">141</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:700">188</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:700">154</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:700">132</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:700">84</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:700">34</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:700">31</td><td class="td-hm" style="background:rgba(59,130,246,.58);color:#fff;font-weight:700">12</td><td class="td-hm td-total-val" style="font-weight:700">1198</td><td class="td-hm td-ganadas-val" style="font-weight:700">92</td>
        </tr>
      </tbody>
    </table>
  </div>
